...
- `enable_group_management` (String) Flag to enable group management. Example: "TRUE"
...
- `last_import_time` (String) Last import timestamp.
...
- `org_import_json` (String) JSON for organization import.
