...
var testSAPConnectionName = util.GenerateRandomName("sap")
...
func TestAccSaviyntSAPConnectionResource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create Step
			{
				Config: testAccSAPConnectionResourceConfig(testSAPConnectionName),
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue("saviynt_sap_connection_resource.ss", tfjsonpath.New("connection_name"), knownvalue.StringExact(testSAPConnectionName)),
					statecheck.ExpectKnownValue("saviynt_sap_connection_resource.ss", tfjsonpath.New("connection_type"), knownvalue.StringExact("SAP")),
			...
			// Update Step
			{
				Config: testAccSAPConnectionResourcePwdMinLenConfig("9"),
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue("saviynt_sap_connection_resource.ss", tfjsonpath.New("password_min_length"), knownvalue.StringExact("9")),
					statecheck.ExpectKnownValue("saviynt_sap_connection_resource.ss", tfjsonpath.New("error_code"), knownvalue.StringExact("0")),
				},
			},

			{
				Config:      testAccSAPConnectionResourceConfig("new_"+testSAPConnectionName),
...
func testAccSAPConnectionResourceConfig(connName string) string {
	return fmt.Sprintf(`
	provider "saviynt" {
  server_url = "%s"
  username   = "%s"
...
func testAccSAPConnectionResourcePwdMinLenConfig(minLen string) string {
	return fmt.Sprintf(`
	provider "saviynt" {
  server_url = "%s"
  username   = "%s"
  ...
  `, os.Getenv("SAVIYNT_URL"),
		os.Getenv("SAVIYNT_USERNAME"),
		os.Getenv("SAVIYNT_PASSWORD"), testSAPConnectionName, minLen,
	)
}
