...
var testGithubRestConnectionName = util.GenerateRandomName("github_rest")
...
func TestAccSaviyntGithubRestConnectionResource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Create Step
			{
				Config: testAccGithubRestConnectionResourceConfig(),
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue("saviynt_github_rest_connection_resource.g", tfjsonpath.New("connection_name"), knownvalue.StringExact(testGithubRestConnectionName)),
					statecheck.ExpectKnownValue("saviynt_github_rest_connection_resource.g", tfjsonpath.New("connection_type"), knownvalue.StringExact("GithubRest")),
					statecheck.ExpectKnownValue("saviynt_github_rest_connection_resource.g", tfjsonpath.New("error_code"), knownvalue.StringExact("0")),
				},
			},
			// Import
			{
				ResourceName:      "saviynt_github_rest_connection_resource.g",
				ImportState:       true,
				ImportStateVerify: true,
			},
			// Update Step
			{
				Config: testAccGithubRestConnectionResourceConfigWithOrgListChange("enorg"),
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue("saviynt_github_rest_connection_resource.g", tfjsonpath.New("organization_list"), knownvalue.StringExact("enorg")),
					statecheck.ExpectKnownValue("saviynt_github_rest_connection_resource.g", tfjsonpath.New("error_code"), knownvalue.StringExact("0")),
				},
			},
		},
...
func testAccGithubRestConnectionResourceConfig() string {
	return fmt.Sprintf(`
	provider "saviynt" {
  server_url = "%s"
  username   = "%s"
  ...
  resource "saviynt_github_rest_connection_resource" "g" {
    ...
    accountParams = {
      ...
      call = {
        call1 = {
          ...
          stageNumber = 0
          http = {
            url = "https://<domain>/orgs/<orgName>/members"
            httpHeaders = {
        ...
        call2 = {
          ...
          stageNumber = 1
          http = {
            url = "https://<domain>/api/v3/users/$${accountName}"
            httpHeaders = {
              Authorization = "$${access_token}"
            }
            httpContentType = "application/x-www-form-urlencoded"
          ...
          colsToPropsMap = {
            ...
            customproperty4 = "suspended_at~#~char"
          }
          multiTrigger = {
          ...
          call = {
            call1 = {
              ...
              http = {
                ...
                url             = "https://<domain>/api/v3/orgs/$${entitlementValue}"
                httpContentType = "application/x-www-form-urlencoded"
                httpMethod      = "GET"
              }
              listField = ""
              ...
              call = {
                call1 = {
                  ...
                  http = {
                    ...
                    url             = "https://<domain>/orgs/$${entitlementValue}/teams"
                    httpContentType = "application/x-www-form-urlencoded"
                    httpMethod      = "GET"
                  }
                  listField = ""
              ...
              call = {
                call1 = {
                  ...
                  http = {
                    ...
                    url             = "https://<domain>/orgs/$${entitlementValue}/repos"
                    httpContentType = "application/x-www-form-urlencoded"
                    httpMethod      = "GET"
                  }
                  listField = ""
          ...
          call = {
            call1 = {
              ...
              http = {
                ...
                url             = "https://<domain>/orgs/$${id}/members?role=member"
                httpContentType = "application/x-www-form-urlencoded"
                httpMethod      = "GET"
              }
              listField    = ""
  ...
  organization_list = "latinorg"
}
  `, os.Getenv("SAVIYNT_URL"),
		os.Getenv("SAVIYNT_USERNAME"),
		os.Getenv("SAVIYNT_PASSWORD"), testGithubRestConnectionName,
	)
}

func testAccGithubRestConnectionResourceConfigWithOrgListChange(org string) string {
	return fmt.Sprintf(`
	provider "saviynt" {
  server_url = "%s"
  username   = "%s"
 ...
 resource "saviynt_github_rest_connection_resource" "g" {
  ...
  `, os.Getenv("SAVIYNT_URL"),
		os.Getenv("SAVIYNT_USERNAME"),
		os.Getenv("SAVIYNT_PASSWORD"), testGithubRestConnectionName, org,
	)
}
