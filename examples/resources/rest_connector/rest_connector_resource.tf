...
resource "saviynt_rest_connection_resource" "example" {
 ...
 {"authentications":{"acctAuth":{"authType":"basic","errorPath":"error.code","maxRefreshTryCount":6,"tokenResponsePath":"access_token","properties":{"userName":"supriya.c@saviynt.com1","password":"sadfasdf"},"authError":["InvalidAuthenticationToken","AuthenticationFailed"],"retryFailureStatusCode":[]},"shaleen_test_rest_12":{"authType":"basic","maxRefreshTryCount":5,"properties":{"userName":"admin","password":"Not4password#"},"authError":[""],"retryFailureStatusCode":[]}}}
  )
